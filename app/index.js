...
client.on('guildMemberAdd', async member => {
    ...
    let resim = new Discord.Attachment('https://cdn.discordapp.com/attachments/798615118421557270/798640607673188472/ewwqeqweqw.gif')
    let kişi = member.guild.memberCount
    let kayıtcırol = member.guild.roles.find(kayıtcı => kayıtcı.id = "798640815756410901")
    let kanal = client.channels.get("798615118421557270")
    kanal.send(`Merhaba <@${member.user.id}> hanedanımıza **hoşgeldin!**\n\nSeninle beraber **${kişi}** kişiyiz.\n\nTagımızı ``ꁚ`` alarak bize destek olabilirsin\n\nHesap kuruluş tarihi; **${tarih}** [**${gün}** gün önce]\n\n${kayıtcırol} sizinle ilgilenecektir.`,)
